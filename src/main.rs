...
impl Database {
    async fn new(url: &str) -> Self {
        ...
        for stmt in [
            ...
            "CREATE TABLE IF NOT EXISTS guild_config ( guild_id BIGINT PRIMARY KEY, threshold_count BIGINT NOT NULL DEFAULT 1, threshold_window BIGINT NOT NULL DEFAULT 10, punishment TEXT NOT NULL DEFAULT 'ban', max_messages_per_minute BIGINT NOT NULL DEFAULT 10, max_duplicate_messages BIGINT NOT NULL DEFAULT 3, max_emojis BIGINT NOT NULL DEFAULT 5, auto_ban_threshold BIGINT NOT NULL DEFAULT 5, link_whitelist TEXT NOT NULL DEFAULT '["youtube.com","github.com"]', banned_words TEXT NOT NULL DEFAULT '["spam","hack","cheat","discord.gg"]' )",
